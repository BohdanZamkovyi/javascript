...
// let ulHead = document.body.getElementsByTagName('ul')[0];
// for (const arrElement of arr) {
//     let li = document.createElement('li');
//     li.innerText = arrElement;
//     ulHead.appendChild(li);
// }
...
//     let div = document.createElement('div');
//     div.innerText = `Назва курсу: ${ArrayElement.title}, Тривалість: ${ArrayElement.monthDuration}`;
//     document.body.appendChild(div);
// }
// =========================
//
...
//     document.getElementsByClassName('item')[i].append(h1, p);
// }
// ==========================
//
let simpsons = [
